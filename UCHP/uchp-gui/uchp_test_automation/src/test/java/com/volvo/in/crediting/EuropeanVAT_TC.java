...
import com.volvo.in.page.crediting.EuropeanVAT;
...
public class EuropeanVAT_TC extends BaseClass {
    ...
    public void setUp(String browserType, String appURL, String sheetName, String testDataFileName,
        ...
        europeanVat = new EuropeanVAT(driver);
    ...
    public void TC05_CreditingAdmCentral_MaintainEuropeanVATImpl() {
        HashMap<String, Object> data = (HashMap<String, Object>) lstData.get(1);
        europeanVat.navigateToEuropeanVAT();
        europeanVat.createNewEuropeanVAT(data);
    }
