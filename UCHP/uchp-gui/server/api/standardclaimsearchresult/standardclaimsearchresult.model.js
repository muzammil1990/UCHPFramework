...
var StandardclaimsearchresultSchema = new mongoose.Schema({
  appealStatus: Number,
...
export default mongoose.model('Standardclaimsearchresult', StandardclaimsearchresultSchema);
