 ...
 * GET     /api/claim/manageclaim/preparenewclaim/ ->  index
 * POST    /api/claim/manageclaim/preparenewclaim              ->  create
 * GET     /api/claim/manageclaim/preparenewclaim/:id          ->  show
 * PUT     /api/claim/manageclaim/preparenewclaim/:id          ->  update
 * DELETE  /api/claim/manageclaim/preparenewclaim/:id          ->  destroy
 */
