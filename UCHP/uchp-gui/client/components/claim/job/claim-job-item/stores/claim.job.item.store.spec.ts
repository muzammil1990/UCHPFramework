...
import IClaimJobStore = uchpClientAngularApp.IClaimJobStore;
import ClaimJobItemModel = uchpClientAngularApp.ClaimJobItemModel;

describe('Service: ClaimJobItemStoreService', () => {
