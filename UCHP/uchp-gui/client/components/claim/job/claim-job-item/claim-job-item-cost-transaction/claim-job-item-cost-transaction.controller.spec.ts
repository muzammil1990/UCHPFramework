...
describe('Component: claimJobItemCostTransaction', () => {
  ...
  it('should exist', () => {
    var bindings = {};
    var ctrl = $componentController('claimJobItemCostTransaction', {
      $attrs: {}
    }, bindings);
    expect(ctrl).toBeDefined();
  });
  it('should have Claim Job Item Store', () => {
    var ctrl = $componentController('claimJobItemCostTransaction', null, {});
