...
describe('Component: claimJobItemLabour', () => {
  ...
  it('should exist', () => {
    var bindings = {};
    var ctrl = $componentController('claimJobItemLabour', {
      $attrs: {}
    }, bindings);
    expect(ctrl).toBeDefined();
  });
  it('should have Claim Job Item Store', () => {
    var ctrl = $componentController('claimJobItemLabour', null, {});
  ...
  it('should have Operation Lists Store', () => {
    var ctrl = $componentController('claimJobItemLabour', null, {});
    expect(ctrl['OperationListsStore']).toBeDefined();
  });
});
