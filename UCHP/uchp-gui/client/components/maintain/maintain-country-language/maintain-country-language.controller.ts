...
module uchpClientAngularApp {
  ...
  class MaintainCountryLanguageController {
  ...
  angular.module('uchpClientAngularApp')
    .component('maintainCountryLanguage', {
      controller: [
        'DispatcherService',
        MaintainCountryLanguageController
      ],
      controllerAs: 'ctrl',
      templateUrl: 'components/maintain/maintain-country-language/maintain-country-language.html'
    });
}
