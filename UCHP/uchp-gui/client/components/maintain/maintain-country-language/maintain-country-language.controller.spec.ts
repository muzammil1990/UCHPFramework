...
describe('Component: Maintain Country Language', () => {
  ...
  it('should exist', () => {
    var bindings = {};
    var ctrl = $componentController('maintainCountryLanguage', {
      $attrs: {}
    }, bindings);
    expect(ctrl).toBeDefined();
  });
  it('should have Dispatcher Service', () => {
    var ctrl = $componentController('maintainCountryLanguage', null, {});
