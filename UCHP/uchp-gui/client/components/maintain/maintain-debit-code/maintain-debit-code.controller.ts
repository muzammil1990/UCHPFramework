...
module uchpClientAngularApp {
  ...
  class MaintainDebitCodeController {
  ...
  angular.module('uchpClientAngularApp')
    .component('maintainDebitCode', {
      controller: [
        'DispatcherService',
        MaintainDebitCodeController
      ],
      controllerAs: 'ctrl',
      templateUrl: 'components/maintain/maintain-debit-code/maintain-debit-code.html'
    });
}
