...
module uchpClientAngularApp {
  ...
  class MaintainFunctionGroupController {
  ...
  angular.module('uchpClientAngularApp')
    .component('maintainFunctionGroup', {
      controller: [
        'DispatcherService',
        MaintainFunctionGroupController
      ],
      controllerAs: 'ctrl',
      templateUrl: 'components/maintain/maintain-function-group/maintain-function-group.html'
    });
}
