...
module uchpClientAngularApp {
  ...
  class MaintainFollowUpCodeController {
  ...
  angular.module('uchpClientAngularApp')
    .component('maintainFollowUpCode', {
      controller: [
        'DispatcherService',
        MaintainFollowUpCodeController
      ],
      controllerAs: 'ctrl',
      templateUrl: 'components/maintain/maintain-follow-up-code/maintain-follow-up-code.html'
    });
}
