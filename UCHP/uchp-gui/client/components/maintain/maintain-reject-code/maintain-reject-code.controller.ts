...
module uchpClientAngularApp {
  ...
  class MaintainRejectCodeController {
  ...
  angular.module('uchpClientAngularApp')
    .component('maintainRejectCode', {
      controller: [
        'DispatcherService',
        MaintainRejectCodeController
      ],
      controllerAs: 'ctrl',
      templateUrl: 'components/maintain/maintain-reject-code/maintain-reject-code.html'
    });
}
