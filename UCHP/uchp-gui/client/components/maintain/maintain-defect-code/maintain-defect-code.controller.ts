...
module uchpClientAngularApp {
  ...
  class MaintainDefectCodeController {
  ...
  angular.module('uchpClientAngularApp')
    .component('maintainDefectCode', {
      controller: [
        'DispatcherService',
        MaintainDefectCodeController
      ],
      controllerAs: 'ctrl',
      templateUrl: 'components/maintain/maintain-defect-code/maintain-defect-code.html'
    });
}
