...
describe('Component: Maintain Cost Adjustment Factor', () => {
  ...
  it('should exist', () => {
    var bindings = {};
    var ctrl = $componentController('maintainCostAdjustmentFactor', {
      $attrs: {}
    }, bindings);
    expect(ctrl).toBeDefined();
  });
  it('should have Dispatcher Service', () => {
    var ctrl = $componentController('maintainCostAdjustmentFactor', null, {});
