...
module uchpClientAngularApp {
  ...
  class MaintainMaterialGroupController {
  ...
  angular.module('uchpClientAngularApp')
    .component('maintainMaterialGroup', {
      controller: [
        'DispatcherService',
        MaintainMaterialGroupController
      ],
      controllerAs: 'ctrl',
      templateUrl: 'components/maintain/maintain-material-group/maintain-material-group.html'
    });
}
