...
module uchpClientAngularApp {
  ...
  class MaintainReturnCodeController {
  ...
  angular.module('uchpClientAngularApp')
    .component('maintainReturnCode', {
      controller: [
        'DispatcherService',
        MaintainReturnCodeController
      ],
      controllerAs: 'ctrl',
      templateUrl: 'components/maintain/maintain-return-code/maintain-return-code.html'
    });
}
